class Article:
    ...
    def __init__(self, author, magazine, title):
        ...
        self._title = None  # Initialize _title to avoid uninitialized attribute access
        self.title = title  # Use the setter to validate the title
...
class Author:
    ...
    def __init__(self, name):
        self._name = None  # Initialize _name to avoid uninitialized attribute access
...
class Magazine:
    ...
    def __init__(self, name, category):
        self._name = None  # Initialize _name to avoid uninitialized attribute access
        self._category = None  # Initialize _category to avoid uninitialized attribute access
        self.name = name  # Use the setter to validate the name
